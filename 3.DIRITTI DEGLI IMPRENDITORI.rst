...
Nell'Art. 42 della Costituzione è prevista la tutela della **PROPRIETÀ PRIVATA** sia del singolo 
...
Al privato spetta un **INDENNIZZO** il cui importo è molto inferiore al valore reale del bene. 

Questo procedimento viene attuato perché l'interesse collettivo prevale su quello privato.

Inoltre lo Stato riconosce all'imprenditore il **diritto di iniziare, cessare, qualunque tipo di attività** 
senza interferenza dello Stato. 

Solo in alcuni casi lo Stato vieta un'attività economica:

1. VA CONTRO LA SALUTE
2. L'AMBIENTE
3. VA CONTRO LA DIGNITA' DELLA PERSONA
4. VA CONTRO LA LIBERTA' DELLA PERSONA